...
import ImgAndText from "components/globalElements/ImgAndText";
...
const About = () => {
  return (
    <>
      <Navbar />
      <SectionWrapper backgroundImage="linear-gradient(90deg, rgba(251,255,181,1) 0%, rgba(131,200,87,0.4051995798319328) 41%, rgba(231,247,163,1) 100%)">
        <Container>
